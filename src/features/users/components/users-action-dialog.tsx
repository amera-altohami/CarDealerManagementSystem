  ...
  return (
    ...
    >
      <DialogContent className='max-w-[calc(100vw-1rem)] sm:max-w-lg'>
        ...
        <div className='max-h-[calc(100vh-10rem)] overflow-y-auto py-1 pe-3 sm:h-105 sm:w-[calc(100%+0.75rem)]'>
          <Form {...form}>
            <form
              id='user-form'
            ...
            >
              <FormField
                ...
                name='firstName'
                render={({ field }) => (
                  <FormItem className='grid gap-y-1 sm:grid-cols-6 sm:items-center sm:gap-x-4 sm:gap-y-1'>
